...
<body>
    @include('/header')
    <div class="container">
        <h2 class="d-flex justify-content-center">Edit Customer</h2>
        <div class="center">
                ...
                <form style="width:500px" action="{{url('Customer/update-customer')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="md-3">
                        <label class="form-label">Hotel</label>
                            <input type="text" class="form-control" name="hotel" value="{{$data->hotel}}">
                            @error('hotel')
                            <span style="color: red">{{$message}}</span>
                            @enderror
                    </div>
                    <div class="md-3">
                        <label class="form-label">Seats</label>
                            <input type="number" class="form-control" name="seats" min="1" value="{{$data->seats}}">
                            @error('seats')
                            <span style="color: red">{{$message}}</span>
                            @enderror
                    </div>
